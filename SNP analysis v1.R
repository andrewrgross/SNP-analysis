### SNP Analysis v1 -- Andrew R Gross -- 2017-10-25 -- An initial effort to filter a table of Single Nucleotide Polymorphisms and identify those most relevant to our study
###
...
setwd('Z:/Data/Andrew/E069 -- Exome of iHT neurons/Yizhou SNPs/csv versions/')
files.list <- list.files()
file.selection <-                   5
current.file <- substr(files.list[file.selection],3,8)
snp.data <- read.csv(files.list[file.selection])
